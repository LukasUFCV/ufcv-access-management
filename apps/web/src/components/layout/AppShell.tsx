...
const navItems: NavItem[] = [
  ...
  { to: '/assets/material', label: 'Matériel', icon: <Laptop size={18} />, permission: 'assets:read' },
  { to: '/resources/software', label: 'Accès logiciels', icon: <LockKeyhole size={18} />, permission: 'software:read' },
  { to: '/resources/information', label: 'Accès aux informations', icon: <Network size={18} />, permission: 'information:read' },
  { to: '/documents', label: 'Documents', icon: <FileText size={18} />, permission: 'documents:read' },
  { to: '/workflows', label: 'Parcours', icon: <ClipboardList size={18} />, permission: 'workflow:read' },
      ...
      <aside className={`sidebar ${isMenuOpen ? 'open' : ''}`}>
        <div className="brand-block">
          ...
          <div>
            ...
            <small>Gestion interne des accès et des engagements</small>
          </div>
        </div>
      ...
      <div className="shell-main">
        <header className="topbar">
          ...
          <div className="topbar-title">
            ...
            <span>{user?.role ? getDisplayLabel(user.role) : 'Utilisateur'}</span>
          </div>
